...
# Define data paths
patches_dir = Path("/data/ja235/camelyon16_project/data/test_patches")
...
class CustomDataset(Dataset):
    def __init__(self, root_dir, transform=None):
        ...
        for folder in ['normal', 'tumor']:
            ...
            self.image_paths.extend(list(folder_path.glob("*.png")))
...
data_loader = DataLoader(dataset, batch_size=64, shuffle=False, num_workers=8, pin_memory=True)
...
# Save to CSV
output_dir = Path("/data/ja235/camelyon16_project/test_tumor_probabilities")
output_dir.mkdir(parents=True, exist_ok=True)
output_file = output_dir / "all_patches_inference_results.csv"
